...
#include "include.h"
inline void CalcCrc32(unsigned char byte,unsigned int *dwCrc32);
//CRC32校验表
const unsigned int s_arrdwCrc32Table[256] =
{
...
*	返 回 值：
*********************************************************************/
int StringCrc32(unsigned char * buf, unsigned int *dwCrc32, int DataLen)
{
	int i=0;
...
int main(void)
{
	int j;
	int k=0;
	char xxx[100]="0123456789";
	StringCrc32(xxx,&k,strlen(xxx));
	printf("xxxx:%x\r\n",k);
