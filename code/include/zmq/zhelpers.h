...
/*
    int i = 0;
    for (; i < size; i++) {
        printf ("Received buffer [%x]", buffer[i]);
    }
    printf("\r\n");
*/
    //printf ("333333 recv len:%d\r\n", size);
...
static int
s_send (void *socket, char *string, int len) {
    //printf("@@@@@@@@@@@@@@@@@@@strlen (string):%d, len:%d\r\n", strlen (string), len);
...
static int
s_sendmore (void *socket, char *string, int len) {
    //printf("@@@@@@@@@@@@@@@@@@@strlen (string):%d, len:%d\r\n", strlen (string), len);
